...
export default function SignaturesPage() {
  ...
  return (
    <div className="max-w-4xl w-full mx-auto px-6 py-8">
      ...
      <p className="text-sm text-gray-500 mt-1 mb-6">Saved signatures and initials are offered whenever you sign. Only you can see them.</p>
          ...
          <section key={kind} className="mb-8" data-testid={`saved-${kind}`}>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="btn-secondary px-3 py-1.5 rounded-md text-sm flex items-center gap-1.5"
              >
